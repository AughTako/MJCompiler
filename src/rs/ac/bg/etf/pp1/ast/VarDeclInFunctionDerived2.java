...
public class VarDeclInFunctionDerived2 extends VarDeclInFunction {

    private VarDeclInFunction VarDeclInFunction;
    private Type Type;
    private String varName;

    public VarDeclInFunctionDerived2 (VarDeclInFunction VarDeclInFunction, Type Type, String varName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclInFunctionDerived2(\n");
