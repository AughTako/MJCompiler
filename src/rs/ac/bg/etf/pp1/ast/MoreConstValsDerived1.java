...
public class MoreConstValsDerived1 extends MoreConstVals {

    private MoreConstVals MoreConstVals;
    private String constName;
    private ConstVals ConstVals;

    public MoreConstValsDerived1 (MoreConstVals MoreConstVals, String constName, ConstVals ConstVals) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MoreConstValsDerived1(\n");
